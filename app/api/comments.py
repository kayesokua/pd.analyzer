...
from .. import db
from ..models.base import Post, Permission, Comment
from . import api
...
@api.route('/comments/<uuid:id>', methods=['GET'])
def get_comment(id):
    comment = Comment.query.get_or_404(str(id))
    return jsonify(comment.to_json())

@api.route('/posts/<uuid:id>/comments/')
...
@api.route('/posts/<uuid:id>/comments/', methods=['POST'])
